...
public class AhoCorasick<V> implements Serializable
{
	...
	public static void main(String[] args)
	{
		...
		ahoCorasick.add(DSUtils.toArrayList("a","b"),"A");
		ahoCorasick.add(DSUtils.toArrayList("a","b","c"),"B");
		ahoCorasick.add(DSUtils.toArrayList("b","c","d"),"C");
		ahoCorasick.add(DSUtils.toArrayList("c","d"),"D");

		List<String> tokens = DSUtils.toArrayList("a","b","c","d","c","d","a","b","c");
