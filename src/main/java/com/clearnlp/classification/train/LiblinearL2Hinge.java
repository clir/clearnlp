 ...
 */
public class LiblinearL2Hinge extends AbstractLiblinear
{
	/**
	 * @param cost the cost.
	 ...
	 * @param bias the bias.
	 */
	public LiblinearL2Hinge(SparseModel model, int numThreads, double cost, double eps, double bias)
	{
	 ...
	 * @param bias the bias.
	 */
	public LiblinearL2Hinge(StringModel model, int labelCutoff, int featureCutoff, int numThreads, double cost, double eps, double bias)
	{
