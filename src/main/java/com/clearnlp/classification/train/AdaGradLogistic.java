 ...
 */
public class AdaGradLogistic extends AbstractAdaGrad
{
	/**
	 * @param alpha the learning rate.
	 * @param rho the smoothing denominator.
	 */
	public AdaGradLogistic(SparseModel model, boolean average, double alpha, double rho)
	{
	 ...
	 * @param rho the smoothing denominator.
	 */
	public AdaGradLogistic(StringModel model, int labelCutoff, int featureCutoff, boolean average, double alpha, double rho)
	{
