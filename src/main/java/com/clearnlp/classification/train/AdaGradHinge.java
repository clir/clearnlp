...
public class AdaGradHinge extends AbstractAdaGrad
{
	 ...
	 */
	public AdaGradHinge(SparseModel model, boolean average, double alpha, double rho)
	{
	 ...
	 * @param rho the smoothing denominator.
	 */
	public AdaGradHinge(StringModel model, int labelCutoff, int featureCutoff, boolean average, double alpha, double rho)
	{
