...
public class Encode
{
	...
	@Option(name="-src", usage="encoding of source files (required)", required=true, metaVar="<string>")
	private String s_source;
	@Option(name="-trg", usage="encoding of target files (required)", required=true, metaVar="<string>")
	...
	public void encode(String inputPath, String inputExtension, String outputExtension, boolean recursive, String source, String target) 
	{
