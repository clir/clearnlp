...
{
	protected final Element           x_top;
	protected final TLanguage         t_language;
	protected final AbstractReader<?> d_reader;
...
//	=================================== LANGUAGE ===================================  
	...
	{
		String language = XmlUtils.getTrimmedTextContentFromFirstElement(x_top, E_LANGUAGE);
...
//	=================================== READER ===================================
	...
	{
		Element eReader = XmlUtils.getFirstElementByTagName(x_top, E_READER);
